...
static const double EPS2 = R3_EPSILON*10.e-1;
...
void processEdgeX(
    TEdge& edge,
    const Matrix& redMatrix0,
    const Matrix& blueMatrix0,
    const Matrix& blueMatrix1,
    const TBox& box,
...
void scalaMethod(
    ...
    Matrix redMatrix0(numX + 1, numY + 1);
    Matrix redMatrix1(numX + 1, numY + 1);
    ...
    Matrix blueMatrix0(numX + 2, numY + 2);
    Matrix blueMatrix1(numX + 2, numY + 2);
